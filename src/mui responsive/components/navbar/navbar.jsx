            ...
            <AppBar position="fixed">
                <Toolbar style={{ display: "flex", justifyContent: "space-between" }}>
                    ...
                    <div className={classes.search}>
                        ...
                        <div className={classes.cancel}><CancelIcon onClick={() => setOpen(false)} /></div>
                    </div>
                    <div className={classes.icons}>

                        <div className={classes.hideSearchbar}>  <SearchIcon className={classes.searchButton} onClick={() => setOpen(true)} />  </div>
